...
const messages = defineMessages({
  allDates: {
    ...
    defaultMessage: 'Xem tất cả ngày học',
  ...
  casualGoalButtonText: {
    ...
    defaultMessage: '1 ngày một tuần',
  ...
  hiddenSection: {
    ...
    defaultMessage: 'Ẩn trong Mục lục, có thể truy cập qua liên kết',
    description: 'Label for hidden section in course outline',
  },
  hiddenSequenceLink: {
    id: 'learning.outline.hiddenSequenceLink',
    defaultMessage: 'Các bài học con không thể di chuyển qua lại với nhau, chỉ có thể truy cập thông qua liên kết của chúng.',
  ...
  goalReminderDetail: {
    ...
    defaultMessage: 'Nếu chúng tôi nhận thấy bạn chưa đạt mục tiêu, chúng tôi sẽ gửi email nhắc nhở cho bạn.',
    description: 'It describe to learner what is goal reminder service',
  },
  goalUnsure: {
    id: 'learning.outline.goalUnsure',
    defaultMessage: 'Chưa chắc chắn',
  },
  handouts: {
  ...
  proctoringInfoPanel: {
    ...
    defaultMessage: 'Khóa học này có các bài kiểm tra giám sát',
  ...
  resumeBlurb: {
    ...
    defaultMessage: 'Tiếp tục từ nơi bạn dừng lại',
  ...
  setGoal: {
    ...
    defaultMessage: 'Để bắt đầu, hãy đặt mục tiêu khóa học bằng cách chọn tùy chọn bên dưới phù hợp nhất với kế hoạch học tập của bạn.',
  ...
  setLearningGoalButtonScreenReaderText: {
    ...
    defaultMessage: 'Đặt kiểu mục tiêu học tập.',
  ...
  setWeeklyGoalDetail: {
    ...
    defaultMessage: 'Đặt mục tiêu giúp bạn có động lực hoàn thành khóa học. Bạn có thể thay đổi bất cứ lúc nào.',
  ...
  startBlurb: {
    ...
    defaultMessage: 'Bắt đầu khóa học của bạn ngay hôm nay',
  },
  tools: {
  ...
  upgradeTitle: {
    ...
    defaultMessage: 'Nhận chứng chỉ đã xác minh',
  ...
  notStartedProctoringStatus: {
    ...
    description: 'It indicate that proctortrack onboarding exam has not started yet',
  },
  ...
  otherCourseApprovedProctoringStatus: {
    ...
    defaultMessage: 'Đã được phê duyệt ở khóa học khác',
  ...
  proctoringCurrentStatus: {
    ...
    defaultMessage: 'Trạng thái đăng ký hiện tại:',
  ...
  notStartedProctoringMessage: {
    ...
    defaultMessage: 'Bạn chưa bắt đầu bài kiểm tra đăng ký.',
  ...
  startedProctoringMessage: {
    ...
    defaultMessage: 'Bạn đã bắt đầu bài kiểm tra đăng ký.',
  ...
  submittedProctoringMessage: {
    ...
    defaultMessage: 'Bạn đã nộp bài kiểm tra đăng ký.',
  ...
  verifiedProctoringMessage: {
    ...
    defaultMessage: 'Bài kiểm tra đăng ký của bạn đã được phê duyệt trong khóa học này.',
  ...
  rejectedProctoringMessage: {
    ...
    defaultMessage: 'Bài kiểm tra đăng ký của bạn đã bị từ chối. Vui lòng thử lại.',
  ...
  errorProctoringMessage: {
    ...
    defaultMessage: 'Đã xảy ra lỗi trong bài kiểm tra đăng ký của bạn. Vui lòng thử lại.',
  ...
  otherCourseApprovedProctoringMessage: {
    ...
    defaultMessage: 'Bài kiểm tra đăng ký của bạn đã được phê duyệt ở một khóa học khác.',
  ...
  otherCourseApprovedProctoringDetail: {
    ...
    defaultMessage: 'Nếu thiết bị của bạn đã thay đổi, chúng tôi khuyên bạn nên hoàn thành bài kiểm tra đăng ký của khóa học này để đảm bảo thiết lập của bạn vẫn đáp ứng yêu cầu giám sát.',
  ...
  expiringSoonProctoringMessage: {
    ...
    defaultMessage: 'Hồ sơ đăng ký của bạn đã được phê duyệt. Tuy nhiên, trạng thái đăng ký của bạn sắp hết hạn. Vui lòng hoàn thành lại đăng ký để tiếp tục làm bài kiểm tra có giám sát.',
  ...
  expiredProctoringMessage: {
    ...
    defaultMessage: 'Trạng thái đăng ký của bạn đã hết hạn. Vui lòng hoàn thành lại đăng ký để tiếp tục làm bài kiểm tra có giám sát.',
  ...
  proctoringPanelGeneralInfo: {
    ...
    defaultMessage: 'Bạn phải hoàn thành quy trình đăng ký trước khi làm bất kỳ bài kiểm tra có giám sát nào. ',
  ...
  proctoringPanelGeneralInfoSubmitted: {
    ...
    defaultMessage: 'Hồ sơ đã nộp của bạn đang được xem xét.',
  ...
  proctoringPanelGeneralTime: {
    ...
    defaultMessage: 'Việc xem xét hồ sơ đăng ký có thể mất hơn 2 ngày làm việc.',
  ...
  proctoringOnboardingButton: {
    ...
    defaultMessage: 'Hoàn thành đăng ký',
  ...
  proctoringOnboardingPracticeButton: {
    ...
    defaultMessage: 'Xem bài kiểm tra đăng ký',
  ...
  proctoringOnboardingButtonNotOpen: {
    ...
    defaultMessage: 'Đăng ký mở vào: {releaseDate}',
  ...
  proctoringOnboardingButtonPastDue: {
    ...
    defaultMessage: 'Quá hạn đăng ký',
