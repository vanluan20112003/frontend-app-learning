...
const messages = defineMessages({
  ...
  share: {
    ...
    defaultMessage: 'Hãy dành một chút thời gian để ăn mừng và chia sẻ tiến độ của bạn.',
    description: 'Text that precedes the (sharing icon) for goal accomplishment ',
  },
  socialMessage: {
    id: 'learning.celebration.social',
    defaultMessage: 'Tôi đang hoàn thành {title} trực tuyến với {platform}. Bạn đang dành thời gian học gì?',
